...
public class InterfaceMicrofilm extends JFrame implements ActionListener {
	...
	public InterfaceMicrofilm(){
		...
		add(pn);
		//titre
				lbtitre=new JLabel("Liste des Microfilms");
				...
				init();
				 ...
				 table.setModel(df);
					...
					pn.add(lbtitre2);
				 String req="select * from `bibliotheque`.`microfilm` order by titre;";
				 int i=0;
				 try{
					 ...
					 while(résultats.next()){
						 ...
						 df.addRow(new Object[]{
								 résultats.getString("num_microfilm"),résultats.getString("cote"),résultats.getString("titre"),
	...
	public static void main(String[] args) {
		InterfaceJournale a= new InterfaceJournale();
		a.setVisible(true);
	...
	public void actionPerformed(ActionEvent e) {
	    ...
	    {
			dispose();
			RechercherMicrofilm ab=new RechercherMicrofilm();
			ab.setVisible(true);
		}
