...
public class AfficherCDrom extends JFrame implements ActionListener{
	...
	public AfficherCDrom(){
		...
		add(pn);
		//titre
				lbtitre=new JLabel("Liste des CD-ROM");
	...
	/*public static void main(String[] args) {
		AfficherCDrom a= new AfficherCDrom();
		a.setVisible(true);
