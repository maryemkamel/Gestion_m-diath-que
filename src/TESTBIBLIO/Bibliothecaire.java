...
public class Bibliothecaire extends JFrame implements ActionListener {
	...
	public Bibliothecaire(){
		...
		add(pn);
		//titre
				lbtitre=new JLabel("Bibliothécaire");
	...
	public void actionPerformed(ActionEvent e) {
		...
		if(e.getSource()==bt){
			String qr="SELECT * from `bibliotheque`.`bibliothecaire` where `login`='"+log+"' and `motDePasse`='"+mdp+"';";
			 try{
