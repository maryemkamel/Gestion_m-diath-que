...
public class AfficherMicroFilm extends JFrame implements ActionListener {
	...
	public AfficherMicroFilm(){
		...
		add(pn);
		//titre
				lbtitre=new JLabel("Liste des Micro-Film");
	...
	public static void main(String[] args) {
		AfficherMicroFilm a= new AfficherMicroFilm();
		a.setVisible(true);
