...
public class InterfaceLivre extends JFrame implements ActionListener {
	...
	public InterfaceLivre(){
		...
		add(pn);
		//titre
				lbtitre=new JLabel("Liste des livres");
				...
				init();
				 ...
				 table.setModel(df);
					...
					pn.add(lbtitre2);
				 String req="select * from `bibliotheque`.`livre` order by titre;";
				 int i=0;
				 try{
					 ...
					 while(résultats.next()){
						 ...
						 df.addRow(new Object[]{
								 résultats.getString("num_livre"),résultats.getString("cote"),résultats.getString("titre"),
								 résultats.getString("auteur"),résultats.getString("etat")});
					 }
	...
	public static void main(String[] args) {
		InterfaceLivre a= new InterfaceLivre();
		a.setVisible(true);
	...
	public void actionPerformed(ActionEvent e) {
	    ...
	    {
			dispose();
			RechercherLivre ab=new RechercherLivre();
			ab.setVisible(true);
		}
